...
export const TRAITS: Trait[] = [
  ...
  { id: "muro_infranqueable",  nombre: "Muro Infranqueable",    descripcion: "Bajo palos, tu presencia intimida. Los delanteros dudan ante ti.",     efecto: "-50% probabilidad de encajar en jugadas de peligro sobre tu portería", sourceable: true, positions: ["GK"] },
  { id: "anticipacion_defensiva", nombre: "Anticipación Defensiva", descripcion: "Lees la jugada un paso antes que el rival. Nadie te sorprende por la espalda.", efecto: "+4 al dado al robar el balón en el mediocampo", sourceable: true, positions: ["CB", "FB"] },
